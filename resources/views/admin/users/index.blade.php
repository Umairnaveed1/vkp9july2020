                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pl-0">
                                    <div class="page-header">
                                        <h2 class="pageheader-title"> Add User </h2> </div>
                                </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pl-0">
                                    <div class="page-header">
                                        <h2 class="pageheader-title"> View Active Users List </h2> </div>
                                </div>
                                <div class="mrg_addres_area">
                                    <div class="col-sm-12">
                                        <div class="row">
...
{{ $users->links() }}                                                        </div>
     ...
     @foreach($users as $agentlevel)
        ...
        @endforeach
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pl-0">
                                    <div class="page-header">
                                        <h2 class="pageheader-title"> View Inactive Users List </h2> </div>
                                </div>
                                <div class="mrg_addres_area">
                                    <div class="col-sm-12">
                                        <div class="row">
