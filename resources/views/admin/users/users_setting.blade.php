...
@section('content')        
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    <div class="ecommerce-widget">
                       ...
                       <form action="{{route('users.settingstore') }}" method="POST" id="validationform" data-parsley-validate="" novalidate="">
                                      @csrf
                                      <div class="row">
                                         <div class="col-12">
		...
		<option value="Friday">Friday</option>
                         ...
                         <input type="time" required="" data-parsley-maxlength="6" placeholder="Time From" name="timefrom" class="form-control"> </div>
                                                                </div>
                                                                       <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label class="col-form-label">Time To :	</label>
              <input type="time" required="" name="timeto" data-parsley-maxlength="6" placeholder="Time To" class="form-control"> </div>
                                                                </div>
            ...
            <input type="checkbox" name="locked" class="custom-control-input">
