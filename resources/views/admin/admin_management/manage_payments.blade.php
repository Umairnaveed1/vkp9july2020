          ...
          <div class="dashboard-ecommerce">
            <div class="container-fluid dashboard-content ">
              ...
              <div class="ecommerce-widget">
               ...
               <input type="number" required="" data-parsley-maxlength="8" placeholder="" class="unique form-control" id="invoice_number">
                                      </div>
                                    </div>
                            ...
                            <div class="card card_address">
                              <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center">
                                  <div class="p-2">
                                    <button type="button" class="btn btn-space btn_promary_custom" id="view_invoice" data-toggle="modal">CANCEL
                                    </button></div>
                                    <div>
                     
                        <form  method="post" action="javascript:void(0)" id="paymentInvoiceForm">
       

                            <div class="p-2">

                      <button type="button"  class="btn btn-space btn_promary_custom" id="send_form" >
                        POST
                            </button>
                                        </div>
                                    ...
                                    <div class="p-2">
                                      <button type="button" class="btn btn-space btn_promary_custom" id="view_invoice" data-toggle="modal">PRINT
                                      </button>
                                    </div>
                                  </div>
                                </div>
       ...
       <script type="text/javascript">
        ...
        $('#add_invoice').on('click',function (e) {
          ...
          var check_row=$('#check_row_'+invoice+'').val();
          //alert(check_row);
          if(check_row==invoice && check_row!='undefined'){
          ...
          $.ajax({
            ...
            success:function(data){ 
               ...
               $("#paymentInvoiceForm").append(
          '<input type="hidden" id="invoicedate_'+data['data'][0]['invoice_date']+'" value="'+data['data'][0]['invoice_date']+'" name="invoicedate[]" />'
                      
      +'<input type="hidden" id="comdue_'+data['data'][0]['AmountDueToVKP']+'" value="'+data['data'][0]['AmountDueToVKP']+'" name="comdue[]" />'
      +'<input type="hidden" id="latefees_'+data['data'][0]['AmountDueToVKP']/100*10+'" name="latefees[]" value="'+data['data'][0]['AmountDueToVKP']/100*10+'">'
      +'<input type="hidden" id="AmountPaid_'+data['data'][0]['AmountDueToVKP']+'" name="AmountPaid[]" value="'+data['data'][0]['AmountDueToVKP']+'">'
                      +'<input type="hidden" name="invoice_id[]" value="'+data['data'][0]['id']+'">'
                      +'<input type="hidden" name="check_row" id="check_row_'+data['data'][0]['id']+'" value="'+data['data'][0]['id']+'">'
                      +'<input type="hidden" id="user_id_'+data['data'][0]['id']+'" name="user_id[]" value="'+data['data'][0]['user_id']+'">'
                      );
                    ...
                    $('.append_searh').append('<tr>'+
                      ...
                      '<td>'+data['data'][0]['AmountDueToVKP']/100*10+'</td>'+
