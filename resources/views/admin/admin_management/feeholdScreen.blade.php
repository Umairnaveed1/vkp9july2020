         ...
         <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
               <div class="page-header">
                  <h2 class="pageheader-title"> Fee Holding Screen </h2>
               </div>
            </div>
         </div>
               ...
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                           ...
                           <table width="100%" class="table table-bordered table_office_manage table_responsive2">
                              <thead>
                                 <tr>
                                    ...
                                    <th width="8%" scope="col">Date Deposit</th>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left"> <a href="#" data-toggle="modal" onclick="viewPopup({{ $feehold->id }})">view</a></td>
                                   <td align="left">                                       <label class="custom-control custom-checkbox custom-control-inline">                                       <input type="checkbox" class="custom-control-input feeRecieptRCVD" data-id="{{$feehold->id}}" name="feeRecieptRCVD" value="{{$feehold->verifiedby==1 && $feehold->verifiedby!=NULL?1:0}}" {{$feehold->verifiedby==1 && $feehold->verifiedby!=NULL?'checked':' '}} {{$feehold->verifiedby==1 && $feehold->verifiedby!=NULL?'disabled':' '}}>                                       <span class="custom-control-label"> </span></label>                                    </td> 
                                    <td align="left">                                       <label class="custom-control custom-checkbox custom-control-inline">                                       <input type="checkbox" class="custom-control-input feeHoldRefund" data-id="{{$feehold->id}}" name="feeHoldRefund" value="{{$feehold->verifiedby==3 && $feehold->verifiedby!=NULL?3:0}}" {{$feehold->verifiedby==3 && $feehold->verifiedby!=NULL?'checked':' '}} {{$feehold->verifiedby==3 && $feehold->verifiedby!=NULL?'disabled':' '}}>                                       <span class="custom-control-label"> </span></label>                                    </td>
                                 </tr>
                                 @endforeach
                              </tbody>
                           </table>
                  ...
                  <div class="col-12">
                     <div class="row mb-4 mt-md-3">
                        <div class="col-sm-12">
                           <a href="{{URL::to('print_feeholdScreen')}}" class="btn_add_agent btn_add_agent_active btnprint">Print</a>
...
<div class="modal" id="myModal_freehold_view">
...
<script type="text/javascript">
    function viewPopup(id) {
        ...
        $.ajax({
            ...
            url:"{{ url('admin_getFeeholdScreen') }}",
            method:"POST",
            ...
            success:function(data)
            {
                ...
                $('#myModal_freehold_view').modal('show');
            }
        });
    }
    jQuery(function ($) { 
