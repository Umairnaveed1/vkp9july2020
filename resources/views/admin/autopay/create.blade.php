              ...
              <input type="hidden" class="form-control criteria_rate span2" readonly="readonly" id="COM_MGT_id" name="InvoiceMgmtCompId">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="form-control cust_frm_cntrl" id="billing_address_zip" name="bill_zipcode_id">
                    ...
                    <!--<form action="/action_page.php">-->
                      <div class="row">
                        ...
                        <div class="col-md-12 align-self-center">
                          <div class="form-group">
                            <button type="button" class="btn btn-primary form_box_cust_btn ml-3 pay_search_btn apply_holding_fee btn_w_search  apply_btn" data-toggle="modal" data-target="#myModal">Apply Holding Fee</button>
                          </div>
                        </div>
                        <br>
                        <div class="col-md-6">
