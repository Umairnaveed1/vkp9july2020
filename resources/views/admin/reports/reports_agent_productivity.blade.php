                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Agent Productivity Report </h2>
                 ...
                 <div class=" property_report_w">
                    <form action="/action_page.php">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                          <div class="form-group">
                            <label class="home_check">All Offices
                              <input type="checkbox">
                              <span class="checkmark"></span>
                            </label>
                          </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="sel1">Office Name :</label>
                            <select class="form-control cust_frm_cntrl" id="sel1">
                              <option>28th Drive</option>
                    ...
                    <div class="row no-gutters mr-3">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="home_check"> Agent Overridable
                              <input type="checkbox">
                              <span class="checkmark"></span>
                            </label>
                          </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="home_check"> Unpaid Invoices
                              <input type="checkbox">
                              <span class="checkmark"></span>
                            </label>
                          </div>
