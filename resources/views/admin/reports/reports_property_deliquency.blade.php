                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Property Deliquency Report </h2>
                 ...
                 <div class=" property_report_w">
                    ...
                    <div class="row no-gutters mr-3">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="home_check"> Balance
                              <input type="checkbox">
                              <span class="checkmark"></span>
                            </label>
                          </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="home_check"> 30-59 Days
                              <input type="checkbox">
                              <span class="checkmark"></span>
                            </label>
                          </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="home_check"> 60-89 Days
                              <input type="checkbox">
                              <span class="checkmark"></span>
                            </label>
                          </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="home_check"> 90+ Days
                              <input type="checkbox">
                              <span class="checkmark"></span>
                            </label>
                          </div>
