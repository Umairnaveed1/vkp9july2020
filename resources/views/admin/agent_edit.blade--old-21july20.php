...
<div class="dashboard-wrapper">
                         ...
                         <div class="page-header">
                            ...
                            <div class="card card_address">
                                  ...
                                  <div class="clear5"></div>
                                   <input type="text" class="form-control" id="name" name="agent_address_1" placeholder="" value="{{ $get_agent_info['agentaddress'] }}">
                                </div>
		...
		<option value="">-----Select------</option>
          ...
          <input type="checkbox" class="custom-control-input" name="active" value="1" checked="">
        @else 
  ...
  <tr>
    <td class="address_td_1">
       ...
       <label class="home_check">Agent Inactive
        @if($get_agent_info['agentadve'] == 0) 
          <input type="checkbox" name="agent_inactive" value="0" checked="">
        @else 
