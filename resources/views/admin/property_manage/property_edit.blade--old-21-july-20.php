...
<input type="checkbox" name="Inactive" value="Inactive" checked="checked">
  @else 
...
@endif
 ...
 @if(isset($get_property->propertyoffline))  
                                
<input type="checkbox" name="propertyoffline" value="Off Line" checked="checked">
  @else 
<input type="checkbox" name="propertyoffline" value="Off Line">
    @endif
 ...
 @if(isset($get_property->propertyonhold))  
                                      
<input type="checkbox" name="propertyonhold" value="On Hold" checked="checked">
  @else 
<input type="checkbox" name="propertyonhold" value="On Hold">
    @endif
 ...
 @if(isset($get_property->propertylegal))   
                                                 
<input type="checkbox" name="propertylegal" value="Legal" checked="checked">
  @else 
<input type="checkbox" name="propertylegal" value="Legal">
    @endif
 ...
 @if(isset($get_property->PropertySlowpay))  
                                           
<input type="checkbox" name="PropertySlowpay" value="Slow Pay" checked="checked">
  @else 
<input type="checkbox" name="PropertySlowpay" value="Slow Pay">
    @endif
...
@endif
 ...
 @if(isset($get_property->propertyguaranteecontract))  

                                                
<input type="checkbox" name="propertyguaranteecontract" value="Guarantee Contract" checked="checked">
  @else 
 <input type="checkbox" name="propertyguaranteecontract" value="Guarantee Contract">
    @endif
   ...
   @if(isset($get_property->PropertyAutopay)) 
<input type="checkbox" name="autopay" value="Auto Pay" checked="checked">
  @else 
<input type="checkbox" name="autopay" value="Auto Pay">
    @endif
  ...
  @if(isset($get_property->propertynocontract))  
                           
<input type="checkbox" name="Contract" value="No Contract" checked="checked">
  @else 
<input type="checkbox" name="Contract" value="No Contract">
    @endif
  ...
  @if(isset($get_property->SuperAuto))  
                             
<input type="checkbox" name="SuperAuto" value="Super Auto Pay" checked="checked">
  @else 
<input type="checkbox" name="SuperAuto" value="Super Auto Pay">
    @endif
