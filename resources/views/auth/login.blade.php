...
<header>
  ...
  <div class="form-group login_input">
    ...
    <input type="UserName" id="UserName" class="form-control @error('UserName') is-invalid @enderror" name="UserName" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="User Name">
     <img src="{{asset('public/assets/images/user_icon.png') }}" width="27" height="27" alt="">
     @error('email')
  ...
  <div class="form-group login_input">
    <input type="password" placeholder="Password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" id="pwd">
    <img src="{{asset('public/assets/images/pass_icon.png')}}" width="27" height="27" alt="">
    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
  ...
  <button type="submit" class="btn_submit_login">
      <img src="{{ asset('public/assets/images/btn_submit.png') }}" width="210" height="51" alt="">
  </button>
</form>
