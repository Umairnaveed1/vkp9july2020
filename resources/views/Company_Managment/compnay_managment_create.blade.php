...
<form action="{{ route('compnay.managment.save') }}" method="POST">   @csrf                                  	
  <tr>
    <td class="address_td_1">MGT. Company :</td>
    <td class="address_td_2"><div class="col-sm-11"><input name="mgt_company_name" id="mgt_company_name" class="form-control @error('mgt_company_name') is-invalid @enderror" placeholder="1st to Rent" type="text" required="required"></div></td>
  </tr>
  <tr>
   
    <td  class="address_td_2"><span class="address_td_1">Office Address : </span></td>
    <td class="address_td_2"><div class="col-sm-11"><input name="office_address" id="office_address" class="form-control @error('office_address') is-invalid @enderror" placeholder="801 E Beck Lane" type="text" required="required"></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="address_td_2"><div class="col-sm-11"><input name="phone_number" id="phone_number" class="form-control @error('phone_number') is-invalid @enderror" placeholder="602-374-7288" type="tel" required="required"></div></td>
  </tr>
  <tr>
    <td class="address_td_1">Fax :	</td>
    <td class="address_td_2"><div class="col-sm-11"><input name="fax_number" id="fax_number" class="form-control @error('fax_number') is-invalid @enderror" placeholder="602-374-7288" type="text" required="required"></div></td>
  </tr>
  <tr>
    <td class="address_td_1">Alt # :</td>
    <td class="address_td_2"><div class="col-sm-11"><input name="alt_number" class="form-control" placeholder="" type="text"></div></td>
  </tr>
  <tr>
        <td class="address_td_1">Email :</td>
        <td class="address_td_2" required="required"><div class="col-sm-11"><input name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="" type="text"></div></td>
      </tr>
  <tr>
    ...
    <td class="address_td_2">
                                            ...
                                            <label class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" name="active" value="1"><span class="custom-control-label"></span>
                                            </label>
                          ...
                          <a href="#" class="btn_add_agent btn_add_agent_active"><img src="{{ URL::asset('public/assets/images/edit_icon.png') }}" alt=""> Edit</a>
                          
                          <a class="btn_add_agent btn_add_agent_2"><img src="{{ URL::asset('public/assets/images/save_icon.png') }}"> Save</a>
                          
                          <a href="#" class="btn_add_agent"><img src="{{ URL::asset('public/assets/images/ad_icon.png') }}" alt=""> Add</a>
