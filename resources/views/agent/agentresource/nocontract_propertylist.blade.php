                                    ...
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <table width="100%" class="table table-bordered table_office_manage table_responsive2 mt-2">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($nocontract as $nocontrac)
                                                    <tr>
                                                        <td>{{ $nocontrac->propertyName }}</td>
                                                        <td>{{ $nocontrac->propertyAd }}</td>
                                                        <td>{{ $nocontrac->mangment_company->mgt_company }}</td>
                                                        <td>{{ $nocontrac->zipcode_list->zipcode }}</td>
                                                        <td>{{ $nocontrac->city_list->cityname }}</td>
                                                        <td>{{ $nocontrac->state_list->statename }}</td>
                                                    </tr>
                                                @endforeach
                                            @else
