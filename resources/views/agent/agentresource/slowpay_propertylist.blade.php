                                ...
                                <div class="add_property_w1">
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <table width="100%" class="table table-bordered table_office_manage table_responsive2 mt-2">
                                            ...
                                            <tbody>
                                                @if(!$slowpay->isEmpty())
                                                @foreach($slowpay as $slowpa)
                                                    <tr>
                                                        <td>{{ $slowpa->propertyName }}</td>
                                                        <td>{{ $slowpa->propertyAd }}</td>
                                                        <td>{{ $slowpa->mangment_company->mgt_company }}</td>
                                                        <td>{{ $slowpa->zipcode_list->zipcode }}</td>
                                                        <td>{{ $slowpa->city_list->cityname }}</td>
                                                        <td>{{ $slowpa->state_list->statename }}</td>
                                                    </tr>
                                                @endforeach
                                            @else
