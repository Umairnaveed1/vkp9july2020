            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">AUTOPAYS</h2>
                    </div>
                </div>
            </div>
                                        ...
                                        <table width="100%" class="table table-bordered table_office_manage table_responsive2 mt-2">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($autopays as $autopay)
                                                    <tr>
                                                        <td>{{ $autopay->propertyName }}</td>
                                                        <td>{{ $autopay->propertyAd }}</td>
                                                        <td>{{ $autopay->mangment_company->mgt_company }}</td>
                                                        <td>{{ $autopay->zipcode_list->zipcode }}</td>
                                                        <td>{{ $autopay->city_list->cityname }}</td>
                                                        <td>{{ $autopay->state_list->statename }}</td>
                                                    </tr>
                                                @endforeach
                                            @else
