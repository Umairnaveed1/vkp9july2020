 ...
 Fee Pending Screen
          ...
          <table width="100%" class="table table-bordered table_office_manage table_responsive2 mt-2">
                             ...
                             @if($res['apartmentbilling_id'] != NULL)
												...
												<td><a href="#" data-toggle="modal" onclick="viewPopup({{ $res['id'] }})">View</a></td>
												</tr>
                                            @endforeach
                                        </tbody>
    ...
    function viewPopup(id) {
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                $('#myModal_viewapprove_bill').modal('show');
            }
        });
    }
</script>
