            ...
            <div class="menu-list">
             ...
             <!-- <li class="nav-item ">
              ...
              @elseif(auth()->user()->is_admin === 1)
                   ...
                   <li class="nav-item ">
              <a class="nav-link {{Request::is('admin/check/create*') ? 'active' : '' }}" href="{{route('check.create')}}" ><img src="{{ asset('public/assets/images/check_manage.png') }}" width="25" height="20" alt=""> CHECKS SCREEN	</a>
