...
class AppartmentBillingController extends Controller
{
    ...
    {
        $leasMonthCount=$this->apartment_month_count('apartment');
    ...
    //    whereBetween(DB::raw('date(created_at)'), [$fromDate, $tillDate])->count();
        ...
        //  dd($revenueLastMonth);
    	return view('agent.appartment_bill.create', $data ,$viewData,compact('company_managment','commission'));
    }
    ...
    public function property(Request $request){
        ...
        public function apartment_month_count($paymentType=''){
        $Invoice = new Invoice();
        $first_agent = Auth::Id();
